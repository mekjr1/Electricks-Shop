...
<head>
    ...
    <title>Xarope MZ Admin Pagina</title>
        ...
        <div class="container">
            <div class="navbar-translate">
                <a href="admin_index.php" class="navbar-brand" rel="tooltip" title="Designed and Coded by Serve(8) Web Solutions, Inc." data-placement="bottom" target="">
                    Venda de Musica online mocambicana
                </a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="../assets/img/blurred-image-1.jpg">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" rel="tooltip" title="Gosta da nossa Pagina no Facebook" data-placement="bottom" href="https://www.facebook.com" target="_blank">
        ...
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                    <br>
                    <div class="col-md-12">
                        <h2 class="title">Produtos (Musicas)</h2>
                        ...
                        <label><b>Pesquisar Produto: &nbsp</b></label>       
                                <form method="POST" action="admin_index_search.php" >
                                    ...
                                    <input type="text" name="search" class="search-query" placeholder="Insira o nome do Produto">
                                </form>
                        </center>
                    </div>
                    <br><hr color="orange">
                    ...
                    ?>   
                        <div class="row-sm-3">
                            ...
                            <div class="caption">
                              ...
                              <h6><a class="btn btn-success btn-round" title="Click for more details!" href="admin_product_details.php?prod_id=<?php echo $res['prod_id'];?>"><i class="now-ui-icons gestures_tap-01"></i>Ver</a><medium class="pull-right">Php<?php echo $res['prod_price']; ?></medium></h6>
                            </div>
