...
<head>
    ...
    <title>Pagina de Pagamento Xarope MZ</title>
...
?>
        ...
        <hr color="orange"> 
        <br><br>
        <h3>O tipo de pagamento será um <b>Dinheiro na entrega</b></h3>
        <h3>Prazo do processo de entrega, mínimo de três (3) dias e máximo de cinco (5) dias úteis.</h3><br>
        <h5>Xarope MZ, Ind.</h5>
        
     <button type="button" class="btn btn-warning btn-round" onclick = "window.print()"><span class="now-ui-icons ui-1_check"></span> Imprimir</button> 
     <a href="user_index.php"><button type="button" class="btn btn-success btn-round"><span class="now-ui-icons ui-1_check"></span> Voltar para Pagina Inicial</button></a>
