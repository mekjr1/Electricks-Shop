...
<br>
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                      <h2>Informacao do produto comprado (Musica)</h2>
                      <hr color="orange">
                      <a href='admin_panel.php' class='btn btn-warning btn-round'>Voltar para o Index</a>
                <br>
                <div class="col-md-12">
...
<div class="panel panel-success panel-size-custom">
          <div class="panel-heading"><h3>Adicionar produtos comprados</h3></div>

          <div class="panel-body">
            <form action="" method="post" enctype="multipart/form-data">
                <div class="form group">
                    <label for="prod_name">Nome do Produto:</label>
                    <input type="text" class="form-control" id="prod_name" name="prod_name" placeholder="Nome do Produto"/>
                    <label for="prod_desc">Descricao do Produto:</label>
                    <input type="text" class="form-control" id="prod_desc" name="prod_desc" placeholder="Descricao"/>
                    <label for="prod_cost">Custo (Php):</label>
                    <input type="text" class="form-control" id="prod_cost" name="prod_cost" placeholder="Valor e.g. 123.4"/>
                    <label for="prod_price">Preco (Php):</label>
                    <input type="text" class="form-control" id="prod_price" name="prod_price" placeholder="Valor e.g. 123.4"/>
                    <label for="prod_qty">Quantidade:</label>
                    <input type="text" class="form-control" id="prod_qty" name="prod_qty" placeholder="Valor e.g. 123"/>
                    ...
                    <div class="form-group">
                        ...
                        <label for="prod_pic1">Foto de Capa 1 (Frente):</label>
                        <div class="input-group">
                            <input type="file" class="form-control" id="prod_pic1" name="prod_pic1">  
                        </div>
                        <label for="prod_pic2">Foto de Capa 2 (Laterais):</label>
                        <div class="input-group">
                            <input type="file" class="form-control" id="prod_pic2" name="prod_pic2">  
                        </div>
                        <label for="prod_pic3">Foto 3 (Titulo das Musicas):</label>
                        <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="prod_serial" name="prod_serial" placeholder="Valor e.g. 1234"/>
                ...
                <div class="form group">
                    ...
                    <i class="now-ui-icons ui-1_check"></i> Adicionar Produto
                    </button> 
                </div>
            </form>
          </div>
...
<footer class="footer" data-background-color="black">
            <div class="container">
                ...
                <div class="copyright">
                    ...
                    </script>, Desenhado & Codificado por Harold Mendes Xaropadas Solucoes, Ind.
                </div>
            </div>
        </footer>
    </div>
