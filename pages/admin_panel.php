        ...
        <div class="container">
            <div class="navbar-translate">
                <a href="admin_index.php" class="navbar-brand" rel="tooltip" title="Designed and Coded by Serve(8) Web Solutions, Inc." data-placement="bottom" target="">
                   Venda de Musica Mocambicana Online
                </a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="../assets/img/blurred-image-1.jpg">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" rel="tooltip" title="Segue-nos no Twitter" data-placement="bottom" href="https://twitter.com" target="_blank">
                            <i class="fa fa-twitter"></i>
                            <p class="d-lg-none d-xl-none">Twitter</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" rel="tooltip" title="Gosta da nossa pagina Facebook" data-placement="bottom" href="https://www.facebook.com" target="_blank">
        ...
        <div class="section">
            <div class="container">
                <div class="button-container">
                    <a href="" class="btn btn-primary btn-round btn-lg">Siga-me</a>
                    <a href="https://www.twitter.com" target="_blank" class="btn btn-default btn-round btn-lg btn-icon" rel="tooltip" title="Siga-nos no Twitter">
                        <i class="fa fa-twitter"></i>
                    </a>
                    <a href="https://www.instagram.com" target="_blank" class="btn btn-default btn-round btn-lg btn-icon" rel="tooltip" title="Siga-nos no Instagram">
                        <i class="fa fa-instagram"></i>
                    </a>
                </div>
               <div class="row">
                    <div class="col-md-6 ml-auto mr-auto">
                        <h4 class="title text-center">Painel do Administrador</h4>
                        ...
                        <div class="tab-pane active" id="products" role="tabpanel">
                            <div class="col-md-12 ml-auto mr-auto">
                                <div class="row collections">
                                    ...
                                    <div class="row">
                                        <div align="center">
                                            <h3>Informacoes do Produto (Musica)</h3>
                                        </div>
                                    </div>
                                    <br>                
                                ...
                                <br><br>
                                <a class="btn btn-success btn-round" href="product_add.php"><i class="now-ui-icons ui-1_simple-add"></i> Adicionar Produto</a>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="supplier" role="tabpanel">
                            <div class="col-md-12 ml-auto mr-auto">
                                <div class="row collections">
                                    ...
                                    <div class="row">
                                        <div align="center">
                                            <h3>Informacao do Fornecedor</h3>
                                        </div>
                                    </div>
                                    <br>                
                                ...
                                <br><br>
                                <a class="btn btn-success btn-round" href="supplier_add.php"><i class="now-ui-icons ui-1_simple-add"></i>Adicionar Fornecedor</a>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="userlog" role="tabpanel">
                            <div class="col-md-12 ml-auto mr-auto">
                                <div class="row collections">
                                        ...
                                        <div class="row">
                                            <div align="center">
                                                <h3>Informacoes de Logs de Usuarios</h3>
                                            </div>
                                        </div>
                                      <?php
                                      include('../config/dbconn.php');
                        ...
                        <div class="tab-pane" id="adminlog" role="tabpanel">
                            <div class="col-md-12 ml-auto mr-auto">
                                <div class="row collections">
                                        ...
                                        <div class="row">
                                            <div align="center">
                                                <h3>Informacoes de Logs do administrador</h3>
                                            </div>
                                        </div>
                                      <?php
                                      include('../config/dbconn.php');
                        ...
                        <div class="tab-pane" id="admin_accounts" role="tabpanel">
                            <div class="col-md-12 ml-auto mr-auto">
                                <div class="row collections">
                                    ...
                                    <div class="row">
                                        <div align="center">
                                            <h3>Informacoes do Administrador</h3>
                                        </div>
                                    </div>
                                    <br>                
                                ...
                                <br><br>
                                <a class="btn btn-success btn-round" href="admin_signup.php"><i class="now-ui-icons ui-1_simple-add"></i> Adicionar conta de administrador</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <footer class="footer" data-background-color="black">
           <div class="container">
                ...
                <div class="copyright">
                    ...
                    </script>, Desenhado e Codificado por Harold Mendes Xaropadas Solucoes, Ind.
                </div>
            </div>
        </footer>
    </div>
