...
<head>
    ...
    <title>Actualizacao Produto Xarope MZ</title>
    ...
    <form action="product_update.php" method="post">
        <div class="form group">
            ...
            <input type="text" class="form-control" id="prod_price" name="prod_price" value="<?php echo $prod_price;?>">
                    ...
                    <div class="form-group">
                        <label for="supp_name">Fornecedor:</label>
                        ...
                        <label for="prod_qty" id="prod_qty" name="prod_qty">Quantidade disponível: &nbsp &nbsp <?php echo $prod_qty;?> Musicas.</label>
                    </div>
                </div>            
             </div>
            </div>
            ...
            <div class="form group">
                <button type="submit" class="btn btn-success btn-round" id="submit" name="update">
                    <i class="now-ui-icons ui-1_check"></i> Actualizar Produto
                </button>
            </div>
    </form>
  </div>
