        ...
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                      ...
                      <a class="btn btn-primary btn-round" href="user_index.php"><i class="now-ui-icons shopping_basket"></i> &nbsp Adicionar mais itens</a>
                      <hr color="orange"> 
...
<form method="post">
  ...
  <button type="submit" name="submit" class="btn btn-success btn-round">Actualizar</button> 
