                    ...
                    <form class="form" method="post" action="">
                        ...
                        <div class="content">
                            ...
                            <div class="input-group form-group-no-border input-lg">
                                ...
                                <input type="text" name="middlename" class="form-control" placeholder="Segundo nome" required>
                            </div>
                            <div class="input-group form-group-no-border input-lg">
                                <span class="input-group-addon">
                                    <i class="now-ui-icons users_circle-08"></i>
                                </span>
                                <input type="text" name="lastname" class="form-control" placeholder="Ultimo nome" required>
                            </div>
                            <div class="input-group form-group-no-border input-lg">
                                <span class="input-group-addon">
                            ...
                            <div class="input-group form-group-no-border input-lg">
                                ...
                                <input type="text" name="address" class="form-control" placeholder="Endereco" required>
                            </div>
                            <div class="input-group form-group-no-border input-lg">
                                <span class="input-group-addon">
                                    <i class="now-ui-icons tech_mobile"></i>
                                </span>
                                <input type="text" name="contact" class="form-control" placeholder="Informacoes contacto" required>
                            </div>
                            <div class="input-group form-group-no-border input-lg">
                                <span class="input-group-addon">
                                    <i class="now-ui-icons users_single-02"></i>
                                </span>
                                <input type="text" id="username" name="username" class="form-control" placeholder="Nome do Usuario" required>
                            </div>
                            <div class="input-group form-group-no-border input-lg">
                                <span class="input-group-addon">
