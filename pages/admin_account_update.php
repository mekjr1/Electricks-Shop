...
<head>
    ...
    <title>Actualizar Conta de Administrador</title>
...
<br>
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                      <h2>Informação da conta de administrador</h2>
                      <hr color="orange">
                      <a href='admin_panel.php' class='btn btn-warning btn-round'>Voltar</a>
                <br>
                <div class="col-md-12">
      

            <div class="panel panel-success panel-size-custom">
                <div class="panel-heading"><h3>Actualizar admin</h3></div>
                  <div class="panel-body">
                    <form action="admin_account_update.php" method="post">
                        ...
                        <div class="form group">
                            ...
                            <i class="now-ui-icons ui-1_check"></i> Actualizar conta
                            </button>
                        </div>
                    </form>
                </div>
