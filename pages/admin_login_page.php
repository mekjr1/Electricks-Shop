...
<head>
    ...
    <title>Pagina de Iniciar Sessao Admin Xarope MZ</title>
                ...
                <div class="card card-login card-plain">
                    <form class="form" method="POST" action="admin_login.php">
                        ...
                        <div class="footer text-center">
                            <button type="submit" class="bbtn btn-primary btn-round btn-lg btn-block" name="submit">Iniciar Sessao</button>
                        </div>
                        <div class="pull-right">
                            <h6>
                                <a href="" class="link">Esqueceu-se da Senh?</a>
                            </h6>
                        </div>
                    </form>
                    <br><br>
        ...
        <footer class="footer">
            <div class="container">
                <div class="copyright">
                    ...
                    </script>,</a> Desenhado & Codificado por Harold Mendes, Ind.
                </div>
            </div>
        </footer>
    </div>
