...
<head>
    ...
    <title>Xarope MZ Pagina de detalhes do produto</title>
...
<div class="main">
    ...
    <div class="section" id="carousel">
        <div class="container">
            ...
            <a class="btn btn-primary btn-round" href="user_index.php"><i class="now-ui-icons arrows-1_minimal-left"></i> &nbsp Voltar para index</a>
            <hr color="orange">
            <div class="col-md-12">
...
?>   
        ...
        if ($prod_qty<=0){
        ?>
         <span style="color:red;">Produto vendido para fora!</span>   
         <?php
        }else{
       ?>
       <b>Itens em estoque: </b><?php echo $res['prod_qty'];?>
       </ul>
       <?php 
    }
?>
        <?php }?> 
            ...
            <button class="btn btn-success btn-round pull-right" data-toggle="modal" data-target="#myModal">
                <i class="now-ui-icons shopping_cart-simple"></i>Adicionar ao Carrinho</button>
              ...
              <div class="modal-dialog">
                ...
                <div class="form group">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Inserir a Quantidade:</h4>
                  </div>
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-primary btn-round" data-dismiss="modal">Fechar</button>
                    <a><button type="submit" name="submit" class="btn btn-success btn-round">Encomendar</button></a>
                  </div>
                </div>
                </form>
