...
<head>
    ...
    <title>Pagina de Pesquisa Administrador</title>
        ...
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                    <br>
                    <div class="col-md-12">
                        <h2 class="title">Produto (Musicas)</h2>
                        ...
                        <label><b>Pesquisar Produto: &nbsp</b></label>       
                                <form method="POST" action="admin_index_search.php" >
                                    ...
                                    <input type="text" name="search" class="search-query" placeholder="Introduzir nome do produto">
                                </form>
                        </center>
                    </div>
                    <br><hr color="orange">
