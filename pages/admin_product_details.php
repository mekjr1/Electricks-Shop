...
<head>
    ...
    <title>Admin detalhes do produto</title>
...
<div class="main">
    ...
    <div class="section" id="carousel">
        <div class="container">
            ...
            <a class="btn btn-primary btn-round" href="admin_index.php"><i class="now-ui-icons arrows-1_minimal-left"></i> &nbsp Voltar para index</a>
            <hr color="orange">
            <div class="col-md-12">
...
?>   
        ...
        if ($prod_qty<=10){
        ?>
         <b>Items no stock: </b><span style="color:red;"><?php echo $res['prod_qty'];?> :Reorder!</span>   
         <?php
        }else{
       ?>
