            ...
            <div class="section section-basic">
                <div class="container">
                    ...
                    <div class="col-md-12">
                        ...
                        <center>
                        <label><b>Pesquisar Produto(Musica): &nbsp</b></label>       
                                <form method="POST" action="index_search.php" >
                                    <input type="image" title="Search" src="assets/img/search.png" alt="Search" />
                                    <input type="text" name="search" class="search-query" placeholder="Introduza o nome da musica">
                                </form>
                        </center>
                    </div>
                    <br><hr color="orange">
...
?>   
    <div class="row-sm-3">
        ...
        <div class="caption">
          ...
          <h6><a class="btn btn-success btn-round" title="Click for more details!" href="pages/product_details.php?prod_id=<?php echo $res['prod_id'];?>"><i class="now-ui-icons gestures_tap-01"></i>Ver</a><medium class="pull-right">Php<?php echo $res['prod_price']; ?></medium></h6>
        </div>
